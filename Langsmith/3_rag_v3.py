...
@traceable(name="load_pdf", metadata={"loader": "PyPDFLoader"})
def load_pdf(path: str):
    loader = PyPDFLoader(path)
    return loader.load()  # list[Document]

@traceable(name="split_documents", metadata={"splitter": "RecursiveCharacterTextSplitter"})
...
@traceable(name="build_vectorstore", metadata={"vectorstore": "FAISS", "embedding_model": "sentence-transformers/all-MiniLM-L6-v2"})
